...
def Model4(input_shape=(2,), noutput=None):
...
def Model5(input_shape=(2,), noutput=None):
    ...
    # Logarithmic scaling of the input data.
    scaled = InputScaling()(inputs)
    x = tf.keras.layers.Dense(64, activation="linear")(scaled)
...
def Model6(input_shape=(2,), noutput=None):
    ...
    # Logarithmic scaling of the input data.
    scaled = InputScaling()(inputs)
    x = tf.keras.layers.Dense(25, activation="tanh")(scaled)
